...
if __name__ == "__main__" and not __package__:
    sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))
    import rrsfnet  # noqa: F401
    __package__ = "rrsfnet"

# Change these to absolute imports if you copy this script outside the keras_retinanet package.
from rrsfnet import layers  # noqa: F401
from rrsfnet import losses
from rrsfnet import models
from rrsfnet.callbacks import RedirectModel
from rrsfnet.callbacks.eval import Evaluate
from rrsfnet.models.retinanet import retinanet_bbox
from rrsfnet.preprocessing.csv_generator import CSVGenerator
from rrsfnet.preprocessing.kitti import KittiGenerator
from rrsfnet.preprocessing.open_images import OpenImagesGenerator
from rrsfnet.preprocessing.pascal_voc import PascalVocGenerator
from rrsfnet.utils.anchors import make_shapes_callback
from rrsfnet.utils.config import read_config_file, parse_anchor_parameters, parse_pyramid_levels
from rrsfnet.utils.gpu import setup_gpu
from rrsfnet.utils.image import random_visual_effect_generator
from rrsfnet.utils.model import freeze as freeze_model
from rrsfnet.utils.tf_version import check_tf_version
from rrsfnet.utils.transform import random_transform_generator
...
def create_callbacks(model, training_model, prediction_model, validation_generator, args):
    ...
    if args.evaluation and validation_generator:
        if args.dataset_type == 'coco':
            from rrsfnet.callbacks.coco import CocoEval
...
def create_generators(args, preprocess_image):
    ...
    if args.dataset_type == 'coco':
        ...
        from rrsfnet.preprocessing.coco import CocoGenerator
...
def main(args=None):
    ...
    '''
    return training_model.fit(train_generator,epochs=args.epochs,verbose=1,steps_per_epoch=args.steps, callbacks=callbacks,
     workers=args.workers, use_multiprocessing=args.multiprocessing,max_queue_size=args.max_queue_size,
     validation_data=validation_generator,initial_epoch=args.initial_epoch)
